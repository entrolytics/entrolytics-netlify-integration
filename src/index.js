...
function generateScriptTag(options) {
  const { websiteId, host = DEFAULT_HOST, autoTrack = true, respectDnt = false, domains } = options;
 ...
 */
export const onPreBuild = async function ({ inputs, constants, utils: { build, status } }) {
 ...
 */
export const onSuccess = async function ({ inputs, utils: { status } }) {
...
export const onPostBuild = async function ({ inputs, constants, utils: { build, status } }) {
